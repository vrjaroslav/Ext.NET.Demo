=================================================
    Ext.NET.MVC 2.3.0 Successfully Installed!
=================================================
  ...
  <runtime>
    <assemblyBinding xmlns="urn:schemas-microsoft-com:asm.v1">
      <dependentAssembly>
        ...
        <bindingRedirect oldVersion="1.0.0.0-5.0.5" newVersion="5.0.6" />
      </dependentAssembly>
      <dependentAssembly>
        <assemblyIdentity name="Ext.Net.Utilities" publicKeyToken="2c34ac34702a3c23" />
        <bindingRedirect oldVersion="0.0.0.0-2.2.1.0" newVersion="2.3.0" />
      </dependentAssembly>
      <dependentAssembly>
